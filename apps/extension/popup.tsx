      ...
      <div className="flex h-[28rem] w-96 flex-col items-center justify-center gap-4 text-center">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-muted-foreground">
            Click the <span>🎙</span> button to start, or upload an audio file
            below.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex w-full max-w-80 items-center gap-2">
            ...
            />
            <WhisperingButton
              tooltipContent="Transcribe uploaded file"
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-foreground/75 text-sm leading-6">
            Click the microphone, upload a file, or press your configured global{" "}
            <WhisperingButton
      ...
      <WhisperingButton
        ...
        onClick={async () => {
          ...
          if (url.pathname === WHISPERING_RECORDINGS_PATHNAME) {
            return await chrome.tabs.update(whisperingTabId, { active: true });
          }
