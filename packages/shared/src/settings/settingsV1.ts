...
export const settingsV1Schema = z.object({
  ...
  "transcription.whisperCpp.serverUrl": z
    .string()
    .default("http://127.0.0.1:8080"), // Added
  "transcription.whisperCpp.model": z
    .string()
    .default("models/ggml-base.en.bin"), // Added
  "transcription.sslVerify": z.boolean().default(true), // Added
...
export const getDefaultSettingsV1 = () =>
  ({
    ...
    "transcription.whisperCpp.serverUrl": "http://127.0.0.1:8080", // Added
    "transcription.whisperCpp.model": "models/ggml-base.en.bin", // Added
    "transcription.sslVerify": true, // Added
